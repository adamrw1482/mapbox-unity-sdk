namespace Mapbox.LocationModule.Scripts.UnityLocationWrappers
{
	...
	public struct MapboxLocationInfoMock : IMapboxLocationInfo
	{
		...
		public float latitude { get { return (float)_location.LatitudeLongitude.Latitude; } }

		public float longitude { get { return (float)_location.LatitudeLongitude.Longitude; } }
